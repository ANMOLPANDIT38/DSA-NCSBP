...
public:
    ...
    // copy constructor
    car(car &S):tyres(4) { // always pass by reference
...
int main() {
    ...
    char carname[] = "Audi";
    // Removed the problematic B definitions and created a single B
    car B(carname, 170, 2002); 
    
    car C(150, 2022, "Maruti"); // Corrected spelling

    // car D = A; // This uses the copy constructor

    car D;
    D = C; // This uses the copy assignment operator (operator=)
